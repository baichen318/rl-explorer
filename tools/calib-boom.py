...
def calib_xgboost_train(dataset):
    for metric in metrics:
        ...
        if metric == "ipc":
            ...
            grid = {'reg_alpha': [1, 0.01], 'reg_lambda': [1, 0.1, 0.01], 'gamma': [0.01, 0.00001, 0], 'min_child_weight': [1], 'colsample_bytree': [1],
                'max_depth': [2, 3, 4], 'subsample': [0.8, 1], 'eta': [0.2, 0.3, 0.4], 'n_estimators': [100, 500, 1000, 2000]}
