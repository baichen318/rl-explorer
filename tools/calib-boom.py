...
def calib_xgboost_train(dataset):
    for metric in metrics:
        ...
        if metric == "ipc":
            ...
            grid = {'reg_alpha': [0.1, 0.01], 'reg_lambda': [0.1, 0.01], 'gamma': [0.00001], 'min_child_weight': [1], 'colsample_bytree': [1],
                'max_depth': [2, 3, 4], 'subsample': [1], 'eta': [0.3], 'n_estimators': [100, 300, 500, 1000]}
